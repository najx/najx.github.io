...
<figure> <img src="{{ '/assets/img/2/1.svg' | relative_url }}" alt="Computing with qubits" width="960" height="540" loading="lazy" decoding="async"> <figcaption>Original schematic of a quantum circuit.</figcaption> </figure>
...
<figure> <img src="{{ '/assets/img/2/2.svg' | relative_url }}" alt="Protecting data in transit" width="960" height="540" loading="lazy" decoding="async"> <figcaption>Original SVG diagram of an encryption flow.</figcaption> </figure>
